...
HD_PWD='C:/Users/Ricardo Filipe/Desktop/tp1/tp1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tutorial.tcl -notrace
