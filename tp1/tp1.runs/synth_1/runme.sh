...
HD_PWD='C:/Users/Ricardo Filipe/Desktop/tp1/tp1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tutorial.tcl
