...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_fit_timer_0_1 -prefix
--               design_1_fit_timer_0_1_ design_1_fit_timer_0_0_sim_netlist.vhdl
...
entity design_1_fit_timer_0_1_Divide_part is
  port (
...
end design_1_fit_timer_0_1_Divide_part;

architecture STRUCTURE of design_1_fit_timer_0_1_Divide_part is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_fit_timer_0_1_Divide_part__parameterized0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of \design_1_fit_timer_0_1_Divide_part__parameterized0\ : entity is "Divide_part";
end \design_1_fit_timer_0_1_Divide_part__parameterized0\;

architecture STRUCTURE of \design_1_fit_timer_0_1_Divide_part__parameterized0\ is
  signal CE : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_fit_timer_0_1_Divide_part__parameterized1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_fit_timer_0_1_Divide_part__parameterized1\ : entity is "Divide_part";
end \design_1_fit_timer_0_1_Divide_part__parameterized1\;

architecture STRUCTURE of \design_1_fit_timer_0_1_Divide_part__parameterized1\ is
  signal CE : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_fit_timer_0_1_Divide_part__parameterized1_0\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_fit_timer_0_1_Divide_part__parameterized1_0\ : entity is "Divide_part";
end \design_1_fit_timer_0_1_Divide_part__parameterized1_0\;

architecture STRUCTURE of \design_1_fit_timer_0_1_Divide_part__parameterized1_0\ is
  signal CE : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_fit_timer_0_1_Divide_part__parameterized1_1\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_fit_timer_0_1_Divide_part__parameterized1_1\ : entity is "Divide_part";
end \design_1_fit_timer_0_1_Divide_part__parameterized1_1\;

architecture STRUCTURE of \design_1_fit_timer_0_1_Divide_part__parameterized1_1\ is
  signal CE : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_fit_timer_0_1_Divide_part__parameterized1_2\ is
  port (
    loop_Bit : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_fit_timer_0_1_Divide_part__parameterized1_2\ : entity is "Divide_part";
end \design_1_fit_timer_0_1_Divide_part__parameterized1_2\;

architecture STRUCTURE of \design_1_fit_timer_0_1_Divide_part__parameterized1_2\ is
  signal CE : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fit_timer_0_1_FIT_timer is
  port (
    Clk : in STD_LOGIC;
    Rst : in STD_LOGIC;
    Interrupt : out STD_LOGIC
  ...
  attribute C_EXT_RESET_HIGH of design_1_fit_timer_0_1_FIT_timer : entity is 1;
  attribute C_FAMILY : string;
  attribute C_FAMILY of design_1_fit_timer_0_1_FIT_timer : entity is "artix7";
  attribute C_INACCURACY : integer;
  attribute C_INACCURACY of design_1_fit_timer_0_1_FIT_timer : entity is 0;
  attribute C_NO_CLOCKS : integer;
  attribute C_NO_CLOCKS of design_1_fit_timer_0_1_FIT_timer : entity is 100000;
end design_1_fit_timer_0_1_FIT_timer;

architecture STRUCTURE of design_1_fit_timer_0_1_FIT_timer is
  signal Clk_En_I_1 : STD_LOGIC;
  signal Clk_En_I_2 : STD_LOGIC;
  signal Clk_En_I_3 : STD_LOGIC;
  signal Clk_En_I_4 : STD_LOGIC;
...
begin
\Using_SRL16s.SRL16s[1].Divide_I\: entity work.design_1_fit_timer_0_1_Divide_part
     port map (
      Clk => Clk,
      Rst => Rst,
      Rst_d1 => Rst_d1,
...
\Using_SRL16s.SRL16s[2].Divide_I\: entity work.\design_1_fit_timer_0_1_Divide_part__parameterized0\
     port map (
      Clk => Clk,
      Clk_En_I_4 => Clk_En_I_4,
      Rst => Rst,
...
\Using_SRL16s.SRL16s[3].Divide_I\: entity work.\design_1_fit_timer_0_1_Divide_part__parameterized1\
     port map (
      Clk => Clk,
      Clk_En_I_3 => Clk_En_I_3,
      Clk_En_I_4 => Clk_En_I_4,
...
\Using_SRL16s.SRL16s[4].Divide_I\: entity work.\design_1_fit_timer_0_1_Divide_part__parameterized1_0\
     port map (
      Clk => Clk,
      Clk_En_I_2 => Clk_En_I_2,
      Clk_En_I_3 => Clk_En_I_3,
...
\Using_SRL16s.SRL16s[5].Divide_I\: entity work.\design_1_fit_timer_0_1_Divide_part__parameterized1_1\
     port map (
      Clk => Clk,
      Clk_En_I_1 => Clk_En_I_1,
      Clk_En_I_2 => Clk_En_I_2,
...
\Using_SRL16s.SRL16s[6].Divide_I\: entity work.\design_1_fit_timer_0_1_Divide_part__parameterized1_2\
     port map (
      Clk => Clk,
      Clk_En_I_1 => Clk_En_I_1,
      Interrupt => Interrupt,
...
entity design_1_fit_timer_0_1 is
  ...
  attribute NotValidForBitStream of design_1_fit_timer_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_fit_timer_0_1 : entity is "design_1_fit_timer_0_0,fit_timer,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_fit_timer_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_fit_timer_0_1 : entity is "fit_timer,Vivado 2017.4";
end design_1_fit_timer_0_1;

architecture STRUCTURE of design_1_fit_timer_0_1 is
  attribute C_EXT_RESET_HIGH : integer;
...
begin
U0: entity work.design_1_fit_timer_0_1_FIT_timer
     port map (
      Clk => Clk,
      Interrupt => Interrupt,
      Rst => Rst
