...
\FSM_onehot_NS_reg[4]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\FSM_onehot_NS_reg[4]_i_12\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_NS_reg[4]_i_16\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\FSM_onehot_NS_reg[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\FSM_onehot_NS_reg[4]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\FSM_onehot_NS_reg[4]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_NS_reg[4]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
