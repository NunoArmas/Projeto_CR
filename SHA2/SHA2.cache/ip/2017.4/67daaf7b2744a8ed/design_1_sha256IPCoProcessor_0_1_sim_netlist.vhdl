...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sha256IPCoProcessor_v1_0_S00_AXI is
  ...
  signal s_compressionI : STD_LOGIC_VECTOR ( 31 downto 6 );
  ...
  signal s_finish : STD_LOGIC_VECTOR ( 30 downto 28 );
...
\FSM_onehot_NS_reg[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \FSM_onehot_NS_reg[4]_i_2_n_0\,
...
\FSM_onehot_NS_reg[4]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
\FSM_onehot_NS_reg[4]_i_17\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \s_extendI_reg_n_0_[21]\,
      I3 => \s_extendI_reg_n_0_[20]\,
      I4 => \s_extendI_reg_n_0_[24]\,
      I5 => \s_extendI_reg_n_0_[25]\,
...
\FSM_onehot_NS_reg[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => \FSM_onehot_NS_reg[4]_i_7_n_0\,
      I4 => \FSM_onehot_NS_reg[4]_i_8_n_0\,
...
\FSM_onehot_NS_reg[4]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000008000"
        ...
        port map (
      I0 => \FSM_onehot_NS_reg[4]_i_9_n_0\,
      I1 => \FSM_onehot_NS_reg[4]_i_10_n_0\,
      I2 => \FSM_onehot_NS_reg[4]_i_11_n_0\,
      I3 => \FSM_onehot_NS_reg[4]_i_12_n_0\,
...
\FSM_onehot_NS_reg[4]_i_5\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => s_extendI(4),
      I3 => s_extendI(5),
      I4 => \FSM_onehot_NS_reg[4]_i_13_n_0\,
      I5 => \FSM_onehot_NS_reg[4]_i_14_n_0\,
...
\FSM_onehot_NS_reg[4]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
        ...
        port map (
      I0 => \FSM_onehot_NS_reg[4]_i_15_n_0\,
      I1 => \FSM_onehot_NS_reg[4]_i_16_n_0\,
      I2 => \FSM_onehot_NS_reg[4]_i_17_n_0\,
      I3 => \FSM_onehot_NS_reg[4]_i_18_n_0\,
      I4 => \s_extendI_reg_n_0_[31]\,
      I5 => \s_extendI_reg_n_0_[30]\,
...
\FSM_onehot_NS_reg[4]_i_8\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \s_extendI_reg_n_0_[12]\,
      I5 => \s_extendI_reg_n_0_[13]\,
...
\s_compressionI_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => s_compressionI(12 downto 9)
    );
...
\s_compressionI_reg[16]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => s_compressionI(16 downto 13)
    );
...
\s_compressionI_reg[20]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => s_compressionI(20 downto 17)
    );
...
\s_compressionI_reg[24]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => s_compressionI(24 downto 21)
    );
...
\s_compressionI_reg[28]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => s_compressionI(28 downto 25)
    );
...
\s_compressionI_reg[31]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2 downto 0) => s_compressionI(31 downto 29)
    );
...
\s_compressionI_reg[8]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => s_compressionI(8 downto 6),
...
\s_finish_reg[28]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\s_finish_reg[29]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
